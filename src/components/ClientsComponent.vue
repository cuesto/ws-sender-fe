...
<v-layout align-start>
    <v-flex>
        <v-data-table :headers="headers" :search="search" :items="clients" :loading="loadingtable" sort-by="name" class="elevation-1">
            <template v-slot:top>
                <v-toolbar flat color="white">
                                    ...
                                    <v-container>
                                        <v-row>
                                            <v-col cols="12" sm="6" md="6">
                                                <v-text-field label="Código*" :rules="[rules.required]" v-model="clientModel.id"></v-text-field>
                                            </v-col>
                                            <v-col cols="12" sm="6" md="6">
                                                <v-text-field label="Nombre*" :rules="[rules.required]" v-model="clientModel.name"></v-text-field>
                                            </v-col>
                                            <v-col cols="12" sm="6" md="6">
                                                <v-text-field label="Celular*" :rules="[rules.required]" v-mask="mask" v-model="clientModel.phone"></v-text-field>
                                            </v-col>
                                        </v-row>
                                    </v-container>
                    ...
                    <v-dialog v-model="uploadModal" max-width="500px">
                        <template v-slot:activator="{ on }">
                            <v-btn :loading="loadingUploadBtn" :disabled="disableUploadBtn" color="orange" dark v-on="on" class="mx-3">
                        ...
                        <v-card>
                            ...
                            <v-card-text>
                                <v-container>
                                    <v-row>
                                        <v-file-input v-model="file" accept="file/*.csv" label="Cargar plantilla .csv"></v-file-input>
                                        <v-tooltip top>
                                    ...
                                    <v-row>
                                        <v-btn @click="UploadClientsTemplate()" color="orange" dark>
                                            <v-icon left>mdi-cloud-upload</v-icon>Importar
                                        </v-btn>
                                        <v-btn class="mx-3" @click="hideUploadModal()" color="blue darken-1" text>Cancelar</v-btn>
                                    </v-row>
                                </v-container>
                            </v-card-text>
                        </v-card>
